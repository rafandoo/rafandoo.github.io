export default {
    StockPrediction: {
        ...
        'img': require('@/assets/img/projects/stock.webp'),
    ...
    FInv: {
        ...
        'category': ['Java'],
        'img': require('@/assets/img/projects/finv.webp'),
    ...
    PomoTimer: {
        ...
        'img': require('@/assets/img/projects/pomotimer.webp'),
    ...
    StrokePrediction: {
        ...
        'category': ['AI', 'Machine Learning', 'Python'],
        'img': require('@/assets/img/projects/stroke.webp'),
    ...
    SpeedTest: {
        ...
        'category': ['Python'],
        'img': require('@/assets/img/projects/speed-test.webp'),
    ...
    EightQueens: {
        ...
        'img': require('@/assets/img/projects/eight-queens.webp'),
