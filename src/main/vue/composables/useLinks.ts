 ...
 * @returns {{ gravatar: string; whatsLink: string | undefined }} An object containing various social and contact links
 * @property {string} gravatar - Gravatar profile image URL
 * @property {string} [whatsLink] - WhatsApp contact link (undefined if no phone)
 */
export function useLinks(info: PersonalInfo): { gravatar: string; whatsLink: string | undefined } {
