export default {
    ...
    frameworks: {
        ...
        items: [
            ...
            {
                title: 'Seaborn',
                logo: new URL('@/main/resources/assets/img/skills/seaborn.svg', import.meta.url)
                    .href,
            },
            {
                title: 'Selenium',
    ...
    tools: {
        ...
        items: [
            ...
            {
                title: 'Postman',
                logo: new URL('@/main/resources/assets/img/skills/postman.svg', import.meta.url)
                    .href,
            },
            {
                title: 'Gradle',
            ...
            {
                title: 'JMeter',
                logo: new URL('@/main/resources/assets/img/skills/jmeter.svg', import.meta.url)
                    .href,
            },
            {
                title: 'Jupyter',
