export default {
    StockPrediction: {
        ...
        img: new URL('@/main/resources/assets/img/projects/stock.webp', import.meta.url).href,
    ...
    FInv: {
        ...
        category: ['Java'],
        img: new URL('@/main/resources/assets/img/projects/finv.webp', import.meta.url).href,
    ...
    CUP: {
        ...
        category: ['Java'],
        img: new URL('@/main/resources/assets/img/projects/cup.webp', import.meta.url).href,
        link: 'https://rafandoo.github.io/cup/',
    },
    PomoTimer: {
        title: 'personal.projects.pomotimer.title',
        subtitle: 'personal.projects.pomotimer.subtitle',
        category: ['Web App', 'Vue.JS'],
        img: new URL('@/main/resources/assets/img/projects/pomotimer.webp', import.meta.url).href,
    ...
    StrokePrediction: {
        ...
        category: ['AI', 'Machine Learning', 'Python'],
        img: new URL('@/main/resources/assets/img/projects/stroke.webp', import.meta.url).href,
    ...
    SpeedTest: {
        ...
        category: ['Python'],
        img: new URL('@/main/resources/assets/img/projects/speed-test.webp', import.meta.url).href,
    ...
    EightQueens: {
        ...
        img: new URL('@/main/resources/assets/img/projects/eight-queens.webp', import.meta.url)
            .href,
    ...
    HelpDesk: {
        ...
        img: new URL('@/main/resources/assets/img/projects/helpdesk.webp', import.meta.url).href,
